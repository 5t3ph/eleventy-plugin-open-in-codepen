...
img {
  ...
  eleventyConfig.addShortcode("postToCodepen", (title, slug, css, html) => {
    ...
    return `<form action="https://codepen.io/pen/define" method="POST" target="_blank">
        ...
        <button class="${buttonClass}" type="submit" data-name="${title}" aria-label="Open ${title} in CodePen"><div class="${buttonIconClass}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="24" height="24" aria-hidden="true" focusable="false">
